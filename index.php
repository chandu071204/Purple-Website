<?php session_start(); 
// Define a message variable to display if logged in as user or admin
			...
			<ul class="menu_top_nav">
				...
				<li class="menu_item has-children">
					<?php if (!isset($_SESSION['user']) && !isset($_SESSION['admin'])): ?>
    	    			...
    	    			<a href="logout.php"> <!-- Redirect to login page -->
        	    			Sign In
        				</a>
					<?php endif; ?>
					<?php if(isset($_SESSION['user'])): ?>
        				...
        				<a href="#">
    	   				...
    	   				<ul class="menu_selection">
        	    			!-- Common Sign Out option for both users and admins -->
